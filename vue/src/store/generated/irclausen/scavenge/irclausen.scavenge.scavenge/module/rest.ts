...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/irclausen/scavenge/scavenge/commit
   */
  queryCommitAll = (
    query?: {
    ...
    this.request<ScavengeQueryAllCommitResponse, RpcStatus>({
      path: `/irclausen/scavenge/scavenge/commit`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/irclausen/scavenge/scavenge/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ScavengeQueryParamsResponse, RpcStatus>({
      path: `/irclausen/scavenge/scavenge/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/irclausen/scavenge/scavenge/scavenge
   */
  queryScavengeAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ScavengeQueryAllScavengeResponse, RpcStatus>({
      path: `/irclausen/scavenge/scavenge/scavenge`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/irclausen/scavenge/scavenge/scavenge/{index}
   */
  queryScavenge = (index: string, params: RequestParams = {}) =>
    this.request<ScavengeQueryGetScavengeResponse, RpcStatus>({
      path: `/irclausen/scavenge/scavenge/scavenge/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
